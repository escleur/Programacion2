...
namespace Ejercicio013
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            string  valor = Conversor.DecimalBinario(-10000.6785);
            Console.WriteLine(valor);
            double valor2 = Conversor.BinarioDecimal(valor);
            Console.WriteLine(valor2);
            valor = Conversor.DecimalBinario(valor2);
            Console.WriteLine(valor);
            valor2 = Conversor.BinarioDecimal(valor);
            Console.WriteLine(valor2);
